...
class SettingsController extends Controller
{
     ...
     */
    public function public(?CacheService $cacheService = null)
    {
        $cacheService ??= app(CacheService::class);

        $data = $cacheService->rememberPublicSettings(function () {
            return [
                ...
                'paypal_enabled'   => (bool) Setting::getValue('paypal_enabled', false),
                'coupons_enabled'  => (bool) Setting::getValue('coupons_enabled', true),
            ];
        });
